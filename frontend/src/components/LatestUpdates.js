    ...
    return (
        <>
            <div className="flex grid rounded-xl shadow-xl lg: mb-5 mr-5 p-3 border-solid ">
                <div className=' p-2' >
                    <span className='inline-block allign-middle text-gray font-[Manrope] font-semibold '>Latest Updates</span>
                </div>
                    ...
                    <div className="col-start-3 col-end-12" >
                        {prop.FAQs.map((item)=>{
                            ...
                            <div className="w-full overflow-x-hidden m-2"  >
                                <p className='text-blue break-all ms-2 text-xs font-[Manrope] font-medium'>{`${item.ques}`}</p>
                            </div>
                            )
                        })}
                    </div>
