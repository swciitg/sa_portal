...
export default function Announcement ({prop}) {
  ...
  return (
        <>
            <div className='rounded-xl w-4/5 sm:w-3/5 mx-20 sm:mx-[120px]  font-[Manrope] shadow-xl mt-10 mb-10 p-3 border-solid '>
                <div className="flex grid justify-between ">
                    ...
                    <div className='col-start-2 col-end-10' >
                        <div className='flex' >
                            ...
                            <div className='p-2'>
                                <span className='inline-block allign-middle word-break-all font-medium min-w-[100%]'>{`${prop.ques}`}</span>
                            </div>
                        </div>
                    </div>
