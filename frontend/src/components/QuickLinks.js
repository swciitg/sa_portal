...
function QuickLinks({ prop }) {
  return (
    <div >
      <h1 className="text-black text-3xl mb-4">Quick Links</h1>
      <div className="flex flex-wrap">
        {prop.Quick_link.map((link) => (
          ...
          >
            <Image src={`https://swc.iitg.ac.in/saPortal${link.Icon.data.attributes.url}`} width={link.Icon.data.attributes.width} height={link.Icon.data.attributes.height}></Image>
